...
hi Boolean         guifg=#99CC99 ctermfg=35
hi Character       guifg=#A8FF60 ctermfg=120
hi Number          guifg=#99CC99 ctermfg=35
hi String          guifg=#A8FF60 ctermfg=120
hi Conditional     guifg=#92C5F7               gui=none ctermfg=33
hi Constant        guifg=#99CC99               gui=none ctermfg=35
hi Cursor          guifg=#F1F1F1 ctermfg=253 guibg=#777777
hi iCursor         guifg=#F1F1F1 ctermfg=253 guibg=#777777
hi Debug           guifg=#BCA3A3 ctermfg=141             gui=none
hi Define          guifg=#66D9EF ctermfg=45
...
hi Error           guifg=#A8FF60 guibg=#1E0010 ctermfg=120
hi ErrorMsg        guifg=#92C5F7 guibg=#232526 gui=none ctermfg=33
hi Exception       guifg=#DAD085               gui=none
hi Float           guifg=#99CC99 ctermfg=35
...
hi Keyword         guifg=#92C5F7               gui=none ctermfg=33
hi Label           guifg=#A8FF60               gui=none ctermfg=120
hi Macro           guifg=#C4BE89               gui=none
hi SpecialKey      guifg=#66D9EF               gui=none

hi MatchParen      guifg=#B7B9B8 guibg=#444444 gui=none
hi ModeMsg         guifg=#A8FF60 ctermfg=120
hi MoreMsg         guifg=#A8FF60 ctermfg=120
hi Operator        guifg=#92C5F7 ctermfg=33
...
hi Repeat          guifg=#92C5F7               gui=none ctermfg=33
hi Search          guifg=#000000 guibg=#B4EC85
" marks
hi SignColumn      guifg=#DAD085 guibg=#232526
hi SpecialChar     guifg=#92C5F7               gui=none ctermfg=33
...
hi TabLine         guibg=#1D1F21 guifg=#808080 ctermbg=Grey
